...
第一次递归：
a = 9, b = -7
a & b = 00000000 00000000 00000000 00001001 & 11111111 11111111 11111111 11111001 = 00000000 00000000 00000000 00001001
a ^ b = 00000000 00000000 00000000 00001001 ^ 11111111 11111111 11111111 11111001 = 11111111 11111111 11111111 11110000
a & b << 1 = 00000000 00000000 00000000 00001001 << 1 = 00000000 00000000 00000000 00010010（即 18）
所以进入下一次递归：func(18, -16)
```
```
第二次递归：
a = 18, b = -16
a & b = 00000000 00000000 00000000 00010010 & 11111111 11111111 11111111 11110000 
      = 00000000 00000000 00000000 00010000
a ^ b = 00000000 00000000 00000000 00010010 ^ 11111111 11111111 11111111 11110000 
      = 11111111 11111111 11111111 11100010
a & b << 1 = 00000000 00000000 00000000 00010000 << 1          = 00000000 00000000 00000000 00100000（即 32）
所以进入下一次递归：func(32, -48)
```
```
第三次递归：
a = 32, b = -48
继续递归下去，到第四次递归：
a = 0，b = -16
因为 a 为 0，满足 if (!a) 的条件，直接返回 b，也就是 -16。
所以func(32, -48) ，最终的返回结果是 -16。
```
```
接着我们回到原始调用 func(9, -7)，在计算完 func(9, -7) 后，最后的计算为：func(a, func(b, c))  = func(4, -16)
继续递归：func(4, -16)
